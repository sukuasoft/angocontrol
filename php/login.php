...
<body style="display: flex; align-items: center; justify-content: center; min-height: 100vh; background-color: var(--color-background);">
    <div class="card" style="width: 100%; max-width: 28rem; padding: 2rem;">
        <div style="text-align: center; margin-bottom: 2rem;">
            ...
            <h1 style="font-size: 1.5rem; font-weight: 700; margin-bottom: 0.5rem;">Angocontrol</h1>
            <p style="color: var(--color-muted-foreground); font-size: 0.875rem;">Sistema de Domótica Inteligente</p>
        </div>
        ...
        <p style="text-align: center; margin-top: 1.5rem; font-size: 0.875rem; color: var(--color-muted-foreground);">
            Não tem uma conta? <a href="register.php" style="color: var(--color-primary); font-weight: 600;">Registre-se</a>
        </p>
    </div>
</body>
</html>
